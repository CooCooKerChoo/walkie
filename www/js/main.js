...
var googleLatLng = [],
    ...
    function createDB(t) {
        ...
        t.executeSql('CREATE TABLE IF NOT EXISTS WALKS (id integer primary key, walkID TEXT, Distance TEXT, Duration TEXT, PathCoordinates TEXT, Images TEXT, WalkTitle Text, WalkDescription Text)');
...
function geolocationWatch() {
   geoWatch = navigator.geolocation.watchPosition(
        function(position) {
            ...
            console.log(totalDistance.toFixed(4));
