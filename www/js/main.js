...
var googleLatLng = [],
    ...
    function createDB(t) {
        ...
        t.executeSql('CREATE TABLE IF NOT EXISTS WALKS (id integer primary key, Distance TEXT, Duration TEXT, PathCoordinates TEXT, Images TEXT, WalkTitle Text, WalkDescription Text)');
